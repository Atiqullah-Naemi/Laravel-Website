<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/">Lara Web</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="{{ Request::is('blog') ? 'active' : '' }}"><a href="{{ route('blog.index') }}">Our Blog</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <img src="/uploads/{{ Auth::user()->avatar }}" class="profile-small">
          {{ Auth::user()->name }}</a>
          <ul class="dropdown-menu">
            <li><a href="{{ route('posts.index') }}">
            <i class="fa fa-thumb-tack"></i> All Posts</a></li>
        ...
        @else
          ...
          <li><a href="{{ route('register') }}"><i class="fa fa-user"> SingUp</i></a></li>
        @endif
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
